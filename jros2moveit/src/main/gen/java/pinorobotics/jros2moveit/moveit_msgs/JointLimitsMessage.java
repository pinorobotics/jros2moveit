...
public class JointLimitsMessage implements Message {
    ...
    /** min_acceleration is assumed to be -max_acceleration true if joint has jerk limits */
    public boolean has_jerk_limits;
    ...
    public JointLimitsMessage withHasJerkLimits(boolean has_jerk_limits) {
        this.has_jerk_limits = has_jerk_limits;
        return this;
    }

    public JointLimitsMessage withMaxJerk(double max_jerk) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(joint_name, other.joint_name)
                ...
                && has_jerk_limits == other.has_jerk_limits
                && max_jerk == other.max_jerk;
    }
