...
@MessageMetadata(
        name = MoveGroupActionGetResultRequestMessage.NAME,
        interfaceType = RosInterfaceType.ACTION)
public class MoveGroupActionGetResultRequestMessage implements Action2GetResultRequestMessage {

    static final String NAME = "moveit_msgs/MoveGroupActionGetResult";

    public Action2GoalIdMessage goal_id;

    @Override
    public MoveGroupActionGetResultRequestMessage withGoalId(Action2GoalIdMessage goal_id) {
