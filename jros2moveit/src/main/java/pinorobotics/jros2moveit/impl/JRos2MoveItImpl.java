...
import pinorobotics.jros2moveit.JRos2MoveIt;
 ...
 */
public class JRos2MoveItImpl<P extends Plan> extends AbstractJRosMoveIt<P>
        implements JRos2MoveIt<P> {

    /** Creates a new instance of the client */
    public JRos2MoveItImpl(
